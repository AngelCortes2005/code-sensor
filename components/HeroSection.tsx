    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      <div className="text-center z-10 max-w-6xl mx-auto px-4 py-20">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-CodeSensor-Secondary/10 to-CodeSensor-Primary/10 border border-CodeSensor-Secondary/20 backdrop-blur-sm mb-8"
        >
        ...
        >
          ...
          <span className="block bg-gradient-to-r from-CodeSensor-Secondary via-CodeSensor-Primary to-CodeSensor-Primary bg-clip-text text-transparent">
            Code Intelligence
          </span>
        </motion.h1>
        ...
        >
          <Link
            ...
            className="group relative px-8 py-4 bg-gradient-to-r from-CodeSensor-Secondary to-CodeSensor-Primary rounded-full font-semibold text-lg text-black overflow-hidden transition-all duration-300 hover:shadow-[0_0_40px_rgba(0,254,116,0.4)] hover:scale-105"
          >
        ...
        >
          {[
            ...
            <div key={index} className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-CodeSensor-Secondary/5 to-CodeSensor-Primary/5 rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-300" />
